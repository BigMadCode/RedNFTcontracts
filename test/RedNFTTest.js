...
//     await expect(instance.safeMint(recipient, "www.redeyedcollection.com/")).to
...
//     expect(
//       instance.safeTransferFrom(recipient, deployerAccount, new BN(1), {
//         from: recipient,
//       })
...
//     await expect(instance.safeMint(recipient, "www.redeyedcollection.com/")).to
//       .eventually.be.fulfilled;
//     expect(instance.approve(deployerAccount, 1, { from: recipient })).to
//       .eventually.be.fulfilled;
...
//     await expect(
//       instance.safeTransferFrom(recipient, deployerAccount, 0, {
//         from: recipient,
//       })
